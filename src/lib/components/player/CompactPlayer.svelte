			...
			<div class="flex flex-col gap-2 md:flex-row md:items-center md:gap-6">
				<div class="flex min-w-0 flex-1 items-center gap-2">
					...
					<div class="min-w-0 flex-1">
						...
						<div class="text-text-muted flex min-w-0 items-center gap-1 text-sm">
							<button
								type="button"
								class="hover:text-accent min-w-0 truncate font-medium disabled:opacity-50"
					...
					<div class="flex shrink-0 items-center gap-1">
						{#if showFavourite && favourites}
							<button
								type="button"
								class="border-border bg-surface-muted flex size-12 items-center justify-center rounded-card border disabled:opacity-40"
						...
						{#if showAdd}
							<div class="relative">
								<button
									type="button"
									class="border-border bg-surface-muted flex size-12 items-center justify-center rounded-card border text-lg font-medium"
				...
				<div class="grid w-full grid-cols-5 items-center md:w-80 lg:w-96">
					<button
						type="button"
						class="flex size-12 items-center justify-center justify-self-center rounded-card {player.shuffle
					...
					<button
						type="button"
						class="border-border bg-surface-muted flex size-12 items-center justify-center justify-self-center rounded-card border disabled:opacity-40"
					...
					<button
						type="button"
						class="bg-accent text-text hover:bg-accent-strong flex size-12 items-center justify-center justify-self-center rounded-card"
					...
					<button
						type="button"
						class="flex size-12 items-center justify-center justify-self-center rounded-card {player.repeat !==
						'off'
							? 'bg-accent text-text hover:bg-accent-strong'
							: 'border-border bg-surface-muted border'}"
